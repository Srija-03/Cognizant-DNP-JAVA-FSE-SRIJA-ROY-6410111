...
public class E_CommerceSearchPlatform {
    ...
    public static void main(String[] args) {
        ...
        int linearResult = LinearSearch.linearSearch(products, "iphone");
        if (linearResult != -1) {
            System.out.println("Linear Search: Product found at index " + linearResult + " -> " + products[linearResult]);
        } else {
...
Conclusion:
Binary search is more efficient and preferred for an e-commerce platform with sorted product lists.
*/
